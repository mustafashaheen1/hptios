...
- (void)baseInit {
    _notSelectedStar = [UIImage imageNamed:@"star_empty.png"];
    _selectedStar = [UIImage imageNamed:@"star_filled.png"];
    _halfSelectedStar = [UIImage imageNamed:@"half_selected_star.png"];
