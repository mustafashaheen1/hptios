...
{
    if ([_delegate respondsToSelector:@selector(itemButtonTappedAtIndex:withDCButton:)]) {
        
        DCPathItemButton *selectedButton = self.itemButtons[itemButton.tag];
//        self.centerImage = selectedButton.image;
//        self.centerHighlightedImage = selectedButton.image;
//        [self setNeedsDisplay];
        ...
        //
        [_delegate itemButtonTappedAtIndex:itemButton.tag withDCButton:self];
