...
@interface ProductSelectAutoCompleteViewController : ParentNavigationViewController <UITableViewDataSource, UITableViewDelegate, SectionHeaderViewDelegate, SKSTableViewDelegate, UIPopoverListViewDataSource, UIPopoverListViewDelegate,ApplyToAllDialogDelegate>

@property (nonatomic, strong) ProductSelectViewModel *viewModel;
...
@property (nonatomic, assign) NSInteger openSectionInblackdex;
...
@property (weak, nonatomic) IBOutlet UIButton *applyToAllButton;
...
@property (nonatomic, strong) NSArray *grnArrayForSelectedProduct;
...
//@property (nonatomic, strong) NSMutableArray *productListItemArray;
