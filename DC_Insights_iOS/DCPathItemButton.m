...
#define imageWidthPop 45
#define imageHeightPop 45
...
- (id)initWithImage:(UIImage *)image highlightedImage:(UIImage *)highlightedImage backgroundImage:(UIImage *)backgroundImage backgroundHighlightedImage:(UIImage *)backgroundHighlightedImage
{
    if (self = [super init]) {
        ...
        //
        CGRect itemFrame = CGRectMake(0, 0, imageWidthPop, imageHeightPop);
        
        if (!backgroundImage || !backgroundHighlightedImage) {
            itemFrame = CGRectMake(0, 0, imageWidthPop, imageHeightPop);
        }
        ...
        _backgroundImageView.center = CGPointMake(self.frame.size.width/2, self.frame.size.height/2);
