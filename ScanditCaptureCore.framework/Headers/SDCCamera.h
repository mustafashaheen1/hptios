 ...
 * Added in version 6.0.0
 *
 * Convenience method for SDCFrameSource.switchToDesiredState:completionHandler:: it is same as calling switchToDesiredState:completionHandler: with the second argument set to nil.
 */
